...
class Banding extends REST_Controller {
    ...
    function index_get() {
       ...
       if($q == "" && $q2 == ""){
            ...
            $data_perkara = $this->db->query("SELECT nomor_perkara_pn, permohonan_banding, penerimaan_memori_banding, penerimaan_kontra_banding, pengiriman_berkas_banding, putusan_banding, (pengiriman_berkas_banding - permohonan_banding) AS lama_proses
